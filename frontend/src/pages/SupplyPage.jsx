    ...
    return (
        <div className="p-4 space-y-6 pb-32 animate-in fade-in relative">
             ...
             <div className="flex justify-between items-stretch h-20 mb-6">
                 <div className="bg-gradient-to-r from-orange-500 to-amber-500 p-6 rounded-[28px] text-white shadow-xl shadow-orange-200 relative overflow-hidden flex-1 mr-3 flex flex-col justify-center">
                 ...
                 <div className="flex flex-col gap-2 h-full">
                     <button onClick={() => navigate('/')} className="bg-white p-3 rounded-2xl shadow-sm text-slate-400 hover:text-indigo-600 transition-colors flex-1 flex items-center justify-center active:scale-95" title="На главную">
                         <ArrowLeft size={20}/>
                     </button>
                     <button onClick={() => setShowSettings(true)} className="bg-white p-3 rounded-2xl shadow-sm text-slate-400 hover:text-indigo-600 transition-colors flex-1 flex items-center justify-center active:scale-95" title="Настройки">
                         <Settings size={20} />
                     </button>
                     <button onClick={handleDownloadReport} className="bg-white p-3 rounded-2xl shadow-sm text-slate-400 hover:text-indigo-600 transition-colors flex-1 flex items-center justify-center active:scale-95" title="Скачать PDF">
                         <FileDown size={20} />
                     </button>
                 </div>
            </div>
